...
{
    private static DemandMultiplierService CreateService(HttpMessageHandler handler, EventsServiceOptions? options = null)
    {
        options ??= new EventsServiceOptions { TimeoutSeconds = 3 };
        ...
        return new DemandMultiplierService(client, optionsWrapper);
    }
