...
public class ForecastService : IForecastService
{
    ...
    public ForecastService(IStockService stockService, IDemandMultiplierService demandMultiplierService)
    {
    ...
    {
        var stock = await _stockService.GetProductStockAsync(pubId, productId);
